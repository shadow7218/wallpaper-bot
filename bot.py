...
async def analyze_image_with_gemini(image_path: str) -> dict:
    ...
    try:
        ...
        payload = {
            "contents": [{"parts": [
                {"text": "Analyze this anime wallpaper. Identify main characters and category. Return only lowercase hashtags separated by spaces. Example: #naruto #animewallpaper"},
